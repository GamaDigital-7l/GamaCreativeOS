    ...
    const fetchData = async () => {
      ...
      try {
        ...
        form.reset({
          ...
          has_trade_in: !!saleData.trade_in_details, // Set based on existence of trade_in_details
          trade_in_device_brand: saleData.trade_in_details?.brand || "",
          trade_in_device_model: saleData.trade_in_details?.model || "",
          trade_in_imei_serial: saleData.trade_in_details?.imei_serial || "",
          trade_in_value: saleData.trade_in_details?.value || 0,
          trade_in_condition: saleData.trade_in_details?.condition || "",
        });
              ...
              <CardContent className="space-y-4">
                ...
                <FormField name="warranty_policy" control={form.control} render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl><Textarea placeholder="Termos de garantia específicos..." className="min-h-[100px]" {...field} /></FormControl><FormMessage /></FormItem>)} />
